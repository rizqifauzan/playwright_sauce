...
module.exports = defineConfig({
  ...
  reporter: [['html', { outputFolder: 'playwright-report' }]], // Menghasilkan HTML report
  ...
  use: {
    ...
    headless: process.env.CI ? true : (process.env.HEADLESS === 'true' || process.env.HEADLESS === undefined),
  ...
  projects: [
    ...
    // For Use firefox and webkit / savari
    // {
    //   name: 'firefox',
